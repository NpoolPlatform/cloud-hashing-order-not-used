...
func init() {
	...
	orderDescCreateAt := orderFields[14].Descriptor()
	...
	orderDescUpdateAt := orderFields[15].Descriptor()
	...
	orderDescDeleteAt := orderFields[16].Descriptor()
	...
	paymentDescUserPaymentTxid := paymentFields[19].Descriptor()
	...
	paymentDescFakePayment := paymentFields[20].Descriptor()
	...
	paymentDescCreateAt := paymentFields[21].Descriptor()
	...
	paymentDescUpdateAt := paymentFields[22].Descriptor()
	...
	paymentDescDeleteAt := paymentFields[23].Descriptor()
