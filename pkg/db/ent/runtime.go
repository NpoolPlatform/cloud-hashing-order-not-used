...
func init() {
	...
	paymentDescUserPaymentTxid := paymentFields[15].Descriptor()
	...
	paymentDescCreateAt := paymentFields[16].Descriptor()
	...
	paymentDescUpdateAt := paymentFields[17].Descriptor()
	...
	paymentDescDeleteAt := paymentFields[18].Descriptor()
