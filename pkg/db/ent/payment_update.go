...
func (pu *PaymentUpdate) SetPayWithBalanceAmount(d decimal.Decimal) *PaymentUpdate {
	pu.mutation.ResetPayWithBalanceAmount()
...
func (pu *PaymentUpdate) AddPayWithBalanceAmount(d decimal.Decimal) *PaymentUpdate {
	pu.mutation.AddPayWithBalanceAmount(d)
	return pu
}
...
func (pu *PaymentUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := pu.mutation.AddedPayWithBalanceAmount(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeFloat64,
			Value:  value,
			Column: payment.FieldPayWithBalanceAmount,
...
func (puo *PaymentUpdateOne) SetPayWithBalanceAmount(d decimal.Decimal) *PaymentUpdateOne {
	puo.mutation.ResetPayWithBalanceAmount()
...
// AddPayWithBalanceAmount adds d to the "pay_with_balance_amount" field.
func (puo *PaymentUpdateOne) AddPayWithBalanceAmount(d decimal.Decimal) *PaymentUpdateOne {
	puo.mutation.AddPayWithBalanceAmount(d)
	return puo
}
...
func (puo *PaymentUpdateOne) sqlSave(ctx context.Context) (_node *Payment, err error) {
	...
	if value, ok := puo.mutation.AddedPayWithBalanceAmount(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeFloat64,
			Value:  value,
			Column: payment.FieldPayWithBalanceAmount,
