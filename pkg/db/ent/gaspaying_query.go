...
func (gpq *GasPayingQuery) GroupBy(field string, fields ...string) *GasPayingGroupBy {
	grbuild := &GasPayingGroupBy{config: gpq.config}
...
func (gpq *GasPayingQuery) Select(fields ...string) *GasPayingSelect {
	...
	selbuild := &GasPayingSelect{GasPayingQuery: gpq}
	selbuild.label = gaspaying.Label
...
func (gpq *GasPayingQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*GasPaying, error) {
	var (
		nodes = []*GasPaying{}
		_spec = gpq.querySpec()
	)
	_spec.ScanValues = func(columns []string) ([]interface{}, error) {
		return (*GasPaying).scanValues(nil, columns)
	}
...
func (gpq *GasPayingQuery) ForUpdate(opts ...sql.LockOption) *GasPayingQuery {
...
func (gpq *GasPayingQuery) ForShare(opts ...sql.LockOption) *GasPayingQuery {
	if gpq.driver.Dialect() == dialect.Postgres {
		gpq.Unique(false)
	}
	gpq.modifiers = append(gpq.modifiers, func(s *sql.Selector) {
...
func (gpq *GasPayingQuery) Modify(modifiers ...func(s *sql.Selector)) *GasPayingSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (gps *GasPayingSelect) Modify(modifiers ...func(s *sql.Selector)) *GasPayingSelect {
