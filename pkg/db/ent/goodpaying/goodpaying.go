...
const (
	// Label holds the string label denoting the goodpaying type in the database.
	Label = "good_paying"
	...
	// Table holds the table name of the goodpaying in the database.
	Table = "good_payings"
)

// Columns holds all SQL columns for goodpaying fields.
var Columns = []string{
	FieldID,
	FieldOrderID,
	FieldAccountID,
...
func StateValidator(s State) error {
	...
	case StateWait, StateDone, StateCanceled, StateTimeout:
		return nil
	default:
		return fmt.Errorf("goodpaying: invalid enum value for state field: %q", s)
	}
}
