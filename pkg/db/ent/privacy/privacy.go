...
// The GasPayingQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type GasPayingQueryRuleFunc func(context.Context, *ent.GasPayingQuery) error

// EvalQuery return f(ctx, q).
func (f GasPayingQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.GasPayingQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.GasPayingQuery", q)
}

// The GasPayingMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type GasPayingMutationRuleFunc func(context.Context, *ent.GasPayingMutation) error

// EvalMutation calls f(ctx, m).
func (f GasPayingMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.GasPayingMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.GasPayingMutation", m)
}

// The GoodPayingQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type GoodPayingQueryRuleFunc func(context.Context, *ent.GoodPayingQuery) error

// EvalQuery return f(ctx, q).
func (f GoodPayingQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.GoodPayingQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.GoodPayingQuery", q)
}

// The GoodPayingMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type GoodPayingMutationRuleFunc func(context.Context, *ent.GoodPayingMutation) error

// EvalMutation calls f(ctx, m).
func (f GoodPayingMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.GoodPayingMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.GoodPayingMutation", m)
}
...
func queryFilter(q ent.Query) (Filter, error) {
	...
	case *ent.CompensateQuery:
		return q.Filter(), nil
	case *ent.GasPayingQuery:
		return q.Filter(), nil
	case *ent.GoodPayingQuery:
		return q.Filter(), nil
	case *ent.OrderQuery:
		return q.Filter(), nil
...
func mutationFilter(m ent.Mutation) (Filter, error) {
	...
	case *ent.CompensateMutation:
		return m.Filter(), nil
	case *ent.GasPayingMutation:
		return m.Filter(), nil
	case *ent.GoodPayingMutation:
		return m.Filter(), nil
